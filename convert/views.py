...
def convert_pdf_to_text(request):
    if request.method == 'GET':
        try:
            text = PDFIngestor.parse('/home/administrator/Documents/cv_convert/convert/media/SP Resume2025.pdf')
...
def resume_pdf(request):
    pdf_path = Path("/home/administrator/Documents/cv_convert/convert/media/SP Resume2025.pdf")
